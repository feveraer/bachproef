package com.frederic.ms.service10.rest;
    ...
    public String get() throws ExecutionException, InterruptedException {
        Callable<ResponseEntity<String>> callable1 = new Callable<ResponseEntity<String>>() {
            ...
            public ResponseEntity<String> call() throws Exception {
                return requestService("http://ms-service-25:8080/rest/");
            }
        };
        Callable<ResponseEntity<String>> traceCallable1 = new TraceCallable<>
                (tracer, spanNamer, callable1, "get_service_25");
        ...
        Callable<ResponseEntity<String>> callable2 = new Callable<ResponseEntity<String>>() {
            @Override
            public ResponseEntity<String> call() throws Exception {
                return requestService("http://ms-service-26:8080/rest/");
            }
        };
        Callable<ResponseEntity<String>> traceCallable2 = new TraceCallable<>
                (tracer, spanNamer, callable2, "get_service_26");
        ...
        Callable<ResponseEntity<String>> callable3 = new Callable<ResponseEntity<String>>() {
            @Override
            public ResponseEntity<String> call() throws Exception {
                return requestService("http://ms-service-27:8080/rest/");
            }
        };
        Callable<ResponseEntity<String>> traceCallable3 = new TraceCallable<>
                (tracer, spanNamer, callable3, "get_service_27");
...
//                        String.class);
        ...
        logger.info(serviceName + ": called service-25, service-26 and service-27");
        StringBuilder sb = new StringBuilder(serviceName)
                ...
                .append(service3Response.getBody()).append("]");
        return sb.toString();
    }
